...
> [!IMPORTANT]
> The user accounts that you're pre-provisioning must be allowed to sign in, be authorized to provision personal sites and must also have a SharePoint license assigned.
